...
class FootballArenaWidget extends StatefulWidget {
  const FootballArenaWidget({super.key, required this.controller});
  final AnimationController controller;

  @override
  State<FootballArenaWidget> createState() => _FootballArenaWidgetState();
}

class _FootballArenaWidgetState extends State<FootballArenaWidget>
