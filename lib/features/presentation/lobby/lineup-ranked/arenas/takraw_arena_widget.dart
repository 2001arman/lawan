...
class TakrawArenaWidget extends StatefulWidget {
  const TakrawArenaWidget({super.key, required this.controller});
  final AnimationController controller;

  @override
  State<TakrawArenaWidget> createState() => _TakrawArenaWidgetState();
}

class _TakrawArenaWidgetState extends State<TakrawArenaWidget>
