...
class BadmintonArenaWidget extends StatefulWidget {
  const BadmintonArenaWidget({super.key, required this.controller});
  final AnimationController controller;

  @override
  State<BadmintonArenaWidget> createState() => _BadmintonArenaWidgetState();
}

class _BadmintonArenaWidgetState extends State<BadmintonArenaWidget>
          ...
          child: AspectRatio(
            ...
            child: AnimatedBuilder(
              ...
              child: SvgPicture.asset(
                'assets/arena/badminton_arena.svg',
