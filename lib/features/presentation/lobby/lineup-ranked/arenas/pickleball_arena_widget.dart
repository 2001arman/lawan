...
class PickleballArenaWidget extends StatefulWidget {
  const PickleballArenaWidget({super.key, required this.controller});
  final AnimationController controller;

  @override
  State<PickleballArenaWidget> createState() => _PickleballArenaWidgetState();
}

class _PickleballArenaWidgetState extends State<PickleballArenaWidget>
          ...
          child: AspectRatio(
            ...
            child: AnimatedBuilder(
              ...
              child: SvgPicture.asset(
                'assets/arena/pickleball_arena.svg',
