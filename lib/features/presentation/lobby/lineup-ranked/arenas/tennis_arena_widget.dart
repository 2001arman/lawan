...
class TennisArenaWidget extends StatefulWidget {
  const TennisArenaWidget({super.key, required this.controller});
  final AnimationController controller;

  @override
  State<TennisArenaWidget> createState() => _TennisArenaWidgetState();
}

class _TennisArenaWidgetState extends State<TennisArenaWidget>
